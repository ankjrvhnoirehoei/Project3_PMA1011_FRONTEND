...
public class ResGetUser {
    ...
    public ResGetUser(String userID, String username, String password, String address, String avatarImg, int starredUser, String phoneNumber, int boughtAmount, int cancelledAmount, int bannedUser, ArrayList<String> vouchersOwned) {
        this.userID = userID;
